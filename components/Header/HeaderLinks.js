        ...
        <CustomDropdown
          ...
          dropdownList={[
            <Link href='/sections#headers'>
              <a className={classes.dropdownLink} onClick={(e) => smoothScroll(e, 'headers')}>
                <Dns className={classes.dropdownIcons} /> Headers
              </a>
            </Link>,
            <Link href='/sections#features'>
              <a className={classes.dropdownLink} onClick={(e) => smoothScroll(e, 'features')}>
                <Build className={classes.dropdownIcons} /> Features
              </a>
            </Link>,
            <Link href='/sections#blogs'>
              <a className={classes.dropdownLink} onClick={(e) => smoothScroll(e, 'blogs')}>
                <ListIcon className={classes.dropdownIcons} /> Blogs
              </a>
            </Link>,
            <Link href='/sections#teams'>
              <a className={classes.dropdownLink} onClick={(e) => smoothScroll(e, 'teams')}>
                <People className={classes.dropdownIcons} /> Teams
              </a>
            </Link>,
            <Link href='/sections#projects'>
              <a className={classes.dropdownLink} onClick={(e) => smoothScroll(e, 'projects')}>
                <Assignment className={classes.dropdownIcons} /> Projects
              </a>
            </Link>,
            <Link href='/sections#pricing'>
              <a className={classes.dropdownLink} onClick={(e) => smoothScroll(e, 'pricing')}>
                <MonetizationOn className={classes.dropdownIcons} /> Pricing
              </a>
            </Link>,
            <Link href='/sections#testimonials'>
              <a className={classes.dropdownLink} onClick={(e) => smoothScroll(e, 'testimonials')}>
                <Chat className={classes.dropdownIcons} /> Testimonials
              </a>
            </Link>,
            <Link href='/sections#contacts'>
              <a className={classes.dropdownLink} onClick={(e) => smoothScroll(e, 'contacts')}>
