        ...
        content={
          <div>
            <div className={classes.left}>
              <List className={classes.list}>
                <ListItem className={classes.inlineBlock}>
                  <a href='https://www.creative-tim.com/?ref=njsmkp-about-us' className={classes.block} target='_blank'>
                    Creative Tim
                  </a>
                </ListItem>
                <ListItem className={classes.inlineBlock}>
                ...
                <ListItem className={classes.inlineBlock}>
                  <a href='http://blog.creative-tim.com/?ref=njsmkp-about-us' className={classes.block} target='_blank'>
                    Blog
                  </a>
                </ListItem>
                <ListItem className={classes.inlineBlock}>
            ...
            <div className={classes.right}>
              ...
              <a href='https://www.creative-tim.com?ref=njsmkp-about-us' target='_blank'>
                Creative Tim
              </a>{' '}
              for a better web.
            </div>
